...
public class Window extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.icons1[15].drawString(matrixStack, "H", position.x + bar / 2 - Fonts.sora[18].getWidth("Damster Client") / 2f - 8, position.y + 15.5, -1);
        Fonts.sora[18].drawCenteredString(matrixStack, "Damster Client", position.x + bar / 2 + 8 / 2f, position.y + 13, -1);
