...
public class ClientUtil implements IMinecraft {
    ...
    static IPCClient client = new IPCClient(1305087868217331815L);
    ...
    public static void startRPC() {
        ...
        client.setListener(new IPCListener(){
            ...
            public void onReady(IPCClient client)
            {
                ...
                builder.setDetails("ver: 0.1b")
                        .setStartTimestamp(OffsetDateTime.now())
                        .setLargeImage("https://media1.tenor.com/m/RU83QvxktTcAAAAd/%D0%B4%D0%BE%D0%BB%D0%B1%D0%BE%D0%B5%D0%B1-%D0%B4%D0%BE%D0%BB%D0%B1%D0%B0%D0%B5%D0%B1.gif", "Damster     the best");
    ...
    public static void sendMesage(String message) {
        ...
        mc.player.sendMessage(gradient("Damster Client", new java.awt.Color(90, 105, 255).getRGB(), new java.awt.Color(245, 98, 255).getRGB()).append(new StringTextComponent(TextFormatting.DARK_GRAY + " -> " + TextFormatting.RESET + message)), Util.DUMMY_UUID);
    }
