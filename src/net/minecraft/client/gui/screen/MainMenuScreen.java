...
public class MainMenuScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        super.render(matrixStack, mouseX, mouseY, partialTicks);
        RenderUtil.Render2D.drawImage(new ResourceLocation("expensive/images/damster.png"), (mc.getMainWindow().scaledWidth() / 2f) - (317.5f / 2) * widthPerc, mc.getMainWindow().scaledHeight() / 2f - 125,317.5f * widthPerc,50.5f * heigthPerc, -1);
